  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "MD Nahid Hasan",
          from_email: form.email,
          to_email: "nhsanto005@gmail.com",
      ...
      >
        ...
        >
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-4'>Name: MD. Nahid Hasan</span>
            <span className='text-white font-medium mb-4'>Email: nhsanto005@gmail.com</span>
            <span className='text-white font-medium mb-4'>WhatsApp: +8801767876110</span>
          </label>
          {/*<label className='flex flex-col'>*/}
